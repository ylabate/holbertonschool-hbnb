...
import PublicUserPage from "@/feature/PublicUserPage";
import LoginScreen from "@/feature/LoginScreen";
import PlacePage from "@/feature/PlacePage";
import CreatePlacePage from "@/feature/CreatePlacePage";
import EditPlacePage from "@/feature/EditPlacePage";
import AdminPage from "@/feature/AdminPage";
      ...
      <section className="flex flex-col h-screen w-full">
        ...
        <section className="flex-1 overflow-y-auto relative bg-color">
          <Routes location={location} key={location.pathname}>
            ...
            <Route
              path="/create-place"
              element={<CreatePlacePage isLoggedIn={isLoggedIn} />}
            />
            <Route
              path="/edit-place/:id"
              element={<EditPlacePage isLoggedIn={isLoggedIn} />}
            />
          </Routes>
        </section>{" "}
      </section>
