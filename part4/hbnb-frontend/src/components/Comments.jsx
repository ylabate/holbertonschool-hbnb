  ...
  return (
    <>
      <section
        ...
        className="comments-backdrop z-[60] fixed inset-0 w-full h-full"
        aria-hidden="true"
        data-overlay="comments-backdrop"
      ></section>

      <section
        className="comments-sheet z-[70] w-full fixed left-1/2 -translate-x-1/2 bottom-0 lg:left-1/2 lg:translate-x-0 lg:right-auto grid grid-cols-1 gap-5 p-4 overflow-y-auto"
        style={{
