...
export default function PlaceComment({
	...
	return (
		<>
			...
			<section
				className="comments-sheet z-30 w-full fixed left-1/2 -translate-x-1/2 bottom-2 2xl:left-[calc(50%+320px)] 2xl:right-auto 2xl:translate-x-0 grid grid-cols-1 gap-5 p-4 overflow-y-auto"
				style={{
